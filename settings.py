...
htmlExperience = {
    "*TITLE*": "Experience",
    "Content": [
        {"*YEAR*": "2022", "*EMPLOYER*": "not yet", "*JOBTITLE*": "Developer", "*DESC*": "Lorem ipsum sic dolores amet..."},
        {"*YEAR*": "2021", "*EMPLOYER*": "Stadin Safka", "*JOBTITLE*": "Waste food handler", "*DESC*": "Lorem ipsum sic dolores amet..."},
    ]
}